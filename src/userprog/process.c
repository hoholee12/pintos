...
load (const char *file_name, void (**eip) (void), void **esp) 
{
  ...
  //wordalign into stack
  *esp -= sizeof(uint8_t);
  slot8 = *esp;
  *slot8 = 0;

  //addresses of argv to stack
  *esp -= sizeof(uint32_t);
  slot32 = *esp;
  *slot32 = 0;  //last one
  for(int i = argc - 1; i >=0; i--){
  ...
  *eip = (void (*) (void)) ehdr.e_entry;
  ...
  //Many OSes do this because of the
  //unpredictable results if a process tried to run code that was in the midst of being changed
  //on disk
